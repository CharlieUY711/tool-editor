/**
 * CoreEditor — Editor de imágenes profesional
 * Repositorio: CharlieUY711/core-tool-editor
 * Path local:  C:\Core\tools\core-editor
 *
...
export default function CoreEditor({ onExport }) {
...
tolerance: 10-60 según nitidez de bordes.` }
  ...
  const exportImage = () => {
    ...
    a.download=`core-editor-export.${outputFormat==="jpeg"?"jpg":outputFormat}`;
    a.click();
  };
